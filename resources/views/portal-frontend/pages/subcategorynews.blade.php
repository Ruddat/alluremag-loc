                    ...
                    <div class="about-author-content pt-15">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">{{ $breadcat->category_name }}</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $breadsubcat->subcategory_name }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="about-tab-btn mt-40">
                        <div class="archive-btn">
                            <ul>
                                <li><span>Category: <span>{{ $breadsubcat->subcategory_name }}</span></span></li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="feature-news-item">
                                        <div class="feature-news-thumb"><a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}">
                                        ...
                                        <div class="feature-news-content">
                                            <p>{{ Str::limit(GoogleTranslate::trans($item->news_details, app()->getLocale()), 120) }} </p>
                                ...
                                <div class="post_gallery_items">
                                    <div class="gallery_item">
                                        ...
                                        <div class="gallery_item_content">
                                            <div class="post-meta">
                                                <div class="meta-categories">
                                                    <a href="#">{{ $breadsubcat->category_name }}</a>
                                                </div>
                                                <div class="meta-date">
                                                    <span>March 26, 2020</span>
                                                </div>
