                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-5">
                        <div class="footer-logo">
                            <a href="#"><img src="{{ asset('frontend/') }}/assets/images/logo-2.png" alt=""></a>
                            <ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="widget wedget-service">
                                        <div class="section-title section-title-2">
                                            <h3 class="title">{{ (GoogleTranslate::trans('Newspark news services', app()->getLocale())) }}</h3>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-item d-block d-md-flex justify-content-between align-items-center">
                        <p>© Copyright 2020, {{ (GoogleTranslate::trans('All Rights Reserved', app()->getLocale())) }}</p>
                        <ul>
                            <li><a href="{{ route('about-us') }}">{{ (GoogleTranslate::trans('About Us', app()->getLocale())) }}</a></li>
                            <li><a href="#">{{ (GoogleTranslate::trans('Advertise', app()->getLocale())) }}</a></li>
                            <li><a href="#">{{ (GoogleTranslate::trans('Privacy & Policy', app()->getLocale())) }}</a></li>
