            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="error-content text-center">
                        <h3 class="title">{{  GoogleTranslate::trans('Page not found', app()->getLocale() )  }}</h3>
                        <p>{{  GoogleTranslate::trans('Sorry the page you were looking for cannot be found. Try searching for the best match or browse the links below:', app()->getLocale() )  }}</p>
                        <ul>
                            <li><a class="main-btn" href="index.html">{{  GoogleTranslate::trans('GO TO HOME', app()->getLocale() )  }}</a></li>
                            <li><a class="main-btn btn-2" href="contact.html">{{  GoogleTranslate::trans('CONTACT US', app()->getLocale() )  }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
